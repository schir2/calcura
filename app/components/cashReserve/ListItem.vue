...
<template>
  <n-modal v-model:show="showModal">
    <CashReserveUpdateForm :id="cashReserve.id" @update="handleUpdate" @cancel="showModal = false"/>
  </n-modal>
  ...
  >
    ...
    <template #headline>
      ...
      <div class="text-[10px] text-skin-muted">target reserve</div>
    </template>
    ...
    <template #aside>
      <div class="flex flex-col gap-3 text-xs">
        ...
        <span class="mt-auto flex items-center gap-1 text-skin-info/70 cursor-not-allowed">
          <base-ico name="info"/> What is a cash reserve? <span class="text-[10px]">(soon)</span>
        </span>
      </div>
    </template>
  </common-rich-list-item>
