...
import type {BrokerageProjection} from "~/components/brokerage/Form.vue";
import {BrokeragePaymentStrategy} from "#shared/types/Brokerage";
...
type Props = {
  projections: Record<BrokeragePaymentStrategy, BrokerageProjection>
}
