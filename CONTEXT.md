...
**Naming:** do NOT call view 1 "the dashboard" — the platform already has `/dashboard` (the Tools hub; see "Glossary — Dashboard / Tools"). The three plan-level views are named **Overview** (view 1), **Simulation** (view 2), **Report** (view 3), confirmed 2026-07-04. (Grill session 2026-07-04.)
