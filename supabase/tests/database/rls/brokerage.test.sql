...
select 'Test Brokerage', 0.07, 10000, plan_id, '00000000-0000-0000-0000-000000000001' from t_plan;
...
select tests.jwt_authenticated('00000000-0000-0000-0000-000000000001');
select lives_ok(
    $$insert into brokerage (name, growth_rate, initial_balance, plan_id, creator_id) select 'Brokerage 2', 0.08, 5000, plan_id, '00000000-0000-0000-0000-000000000001' from t_plan$$,
...
select tests.jwt_authenticated('00000000-0000-0000-0000-000000000002');
select throws_ok(
    $$insert into brokerage (name, growth_rate, initial_balance, plan_id, creator_id) select 'Stolen', 0.07, 10000, plan_id, '00000000-0000-0000-0000-000000000001' from t_plan$$,
    '42501',
    NULL,
