...
(
    ...
    growth_rate               NUMERIC                   NOT NULL,
    initial_balance           NUMERIC                   NOT NULL,
    contribution_strategy     ira_contribution_strategy          DEFAULT 'fixed',
    contribution_percentage   NUMERIC,
    contribution_fixed_amount NUMERIC,
    created_at                TIMESTAMPTZ               NOT NULL DEFAULT now(),
    edited_at                 TIMESTAMPTZ               NOT NULL DEFAULT now(),
...
(
    ...
    growth_rate               NUMERIC                        NOT NULL,
    initial_balance           NUMERIC                        NOT NULL,
    contribution_strategy     roth_ira_contribution_strategy      DEFAULT 'fixed',
    contribution_percentage   NUMERIC,
    contribution_fixed_amount NUMERIC,
    created_at                TIMESTAMPTZ                    NOT NULL DEFAULT now(),
    edited_at                 TIMESTAMPTZ                    NOT NULL DEFAULT now(),
...
(
    ...
    growth_rate                            NUMERIC                            NOT NULL,
    initial_balance                        NUMERIC                            NOT NULL,
    elective_contribution_strategy         tax_deferred_contribution_strategy,
