...
import {
  ...
  type BrokerageInvestment, brokerageInvestmentDefaults,
...
const {initialValues = brokerageInvestmentDefaults, mode} = defineProps<Props>();
const emit = defineEmits(["update", "cancel", "create"]);
const modelRef = ref<BrokerageInvestmentPartial>(initialValues)
