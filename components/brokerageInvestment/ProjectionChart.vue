...
import type {BrokerageInvestmentProjection} from "~/components/brokerageInvestment/Form.vue";
import {BrokerageInvestmentPaymentStrategy} from "~/models/brokerageInvestment/BrokerageInvestment";
...
interface Props {
  projections: Record<BrokerageInvestmentPaymentStrategy, BrokerageInvestmentProjection>
}
...
const chartData = computed(() => {
  ...
  return ({
    ...
    datasets: [
      ...
      {
        label: 'Percentage of BrokerageInvestment',
        backgroundColor: darkTheme.common.successColor,
        borderColor: darkTheme.common.successColor,
        data: props.projections.percentage_of_brokerageInvestment.data,
      },
      {
