...
const {initialValues = taxDeferredInvestmentDefaults, mode, incomes} = defineProps<Props>();
...
const {
  ...
  handleUpdate,
  handleCancel
} = useCrudFormWithValidation(initialValues, emit, useTaxDeferredInvestmentValidator);
